...
const SectionKontak = () => {
  return (
    <section className="bg-gray-900 py-16 px-6 md:px-20 text-white">
      ...
      >
        <h2 className="text-teal-600 text-3xl font-bold mb-4">Hubungi Kami</h2>
        ...
        <Link
          to="/kontak"
          className="inline-block bg-teal-600 text-white hover:bg-teal-700 font-semibold px-6 py-3 rounded-full shadow-md transition-all duration-300"
        >
          Halaman Kontak
        </Link>
      </motion.div>
